...
},{"./Browser/Backend.js":2}],2:[function(require,module,exports){
'use strict';
...
var bindEvents = ['status'];
bindEvents.forEach(function (event) {
...
var getPlaylistData = function getPlaylistData() {
	return pl.toJSON();
};
...
var moveSong = function moveSong(grp, oldIndex, newIndex) {
	pl.orderSong(grp, oldIndex, grp, newIndex);
};

var addPathToList = function addPathToList(list, path) {
